 ...
 *
 * Also look at https://github.com/hobbzey/Simplest-SmartThings-ESP8266-Blinds
 */
...
metadata {
	...
	tiles(scale: 2) {
		standardTile("DeviceTrigger", "device.triggerswitch", width: 6, height: 6, canChangeIcon: true, canChangeBackground: true) {
        ...
        valueTile("stop", "device.stop", decoration: "flat", width: 6, height: 2) {
        	state "stop", label: 'STOP', action: "stop", backgroundColor: "#f20119"
         }
	
		main (["DeviceTrigger", "stop"])
		details(["DeviceTrigger", "stop", "oscTrigger", "modeTrigger", "speedTrigger", "timerAddTrigger", "timerMinusTrigger"])
	}
}
...
def parse(String description) {
    ...
    switch (whichTile) {
        ...
        case 'mainoff':
			...
			return result
        case 'mainstop':
			def result = createEvent(name: "switch", value: "stop", isStateChange: true)
			return result
        default:
